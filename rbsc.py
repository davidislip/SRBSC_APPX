...
def DeterministicRedBlue(Reds, Blues, Sets, Weights = None, LIMIT = None, output = False, testing = False, mipgap = None, env = None):
  '''
...
def DeterministicRedBlueAugmented(Reds, Blues, AugmentedSets, Relax = False, Weights = None, q = None, env = None):
